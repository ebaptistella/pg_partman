...
SELECT has_table('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'), 'Check time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT has_table('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    'Check time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT hasnt_table('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT col_is_pk('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'), ARRAY['col1'], 
    'Check for primary key in time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT col_is_pk('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    'Check for primary key in time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'120 mins'::interval, 'YYYY_MM_DD_HH24MI'));
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'), 'partman_basic', 
    ARRAY['SELECT','INSERT','UPDATE'], 
    'Check partman_basic privileges of time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'));
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    'Check partman_revoke privileges of time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'));
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'), 
    ARRAY[10], 'Check count from time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0), 'YYYY_MM_DD_HH24MI'));
...
SELECT results_eq('SELECT count(*)::int FROM partman_test.time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'60 mins'::interval, 'YYYY_MM_DD_HH24MI'), 
    ARRAY[5], 'Check count from time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'60 mins'::interval, 'YYYY_MM_DD_HH24MI'));
...
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    ARRAY['SELECT'], 'Check partman_revoke privileges of time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'150 mins'::interval, 'YYYY_MM_DD_HH24MI'));
...
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    '{}'::text[], 'Check partman_revoke privileges of time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 mins'::interval, 'YYYY_MM_DD_HH24MI'));
SELECT table_privs_are('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
    ...
    'Check partman_basic privileges of time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 mins'::interval, 'YYYY_MM_DD_HH24MI'));
SELECT table_owner_is ('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 mins'::interval, 'YYYY_MM_DD_HH24MI'), 'partman_owner', 
    'Check that ownership change worked for time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'180 mins'::interval, 'YYYY_MM_DD_HH24MI'));
...
SELECT is_empty('SELECT * FROM partman_test.time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '30min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 30.0)+'30 mins'::interval, 'YYYY_MM_DD_HH24MI'), 
    'Check time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 

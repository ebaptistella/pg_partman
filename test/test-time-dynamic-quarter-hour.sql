...
SELECT has_table('partman_test', 'time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
                '15min'::interval * floor(date_part('minute', CURRENT_TIMESTAMP) / 15.0), 'YYYY_MM_DD_HH24MI'), 'Check time_dynamic_table_part'||to_char(date_trunc('hour', CURRENT_TIMESTAMP) + 
